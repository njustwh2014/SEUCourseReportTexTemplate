...
\pagestyle{fancy}
\fancyhf{}  
\fancyhead[C]{\zihao{5}  \kaishu 模式识别原理课程报告}
...
\newcommand{\upcite}[1]{\textsuperscript{\textsuperscript{\cite{#1}}}}%引用角标
...
%============== 论文正文   =================
\pagestyle{fancy}
\include{body/Ch0IntroMnist}
\include{body/Ch1KNN}
\include{body/Ch2Bayes}
\include{body/Ch3Logistics}
